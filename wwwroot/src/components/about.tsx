...
export function About() {
    return (
        <Container className="about--main about--container">
            ...
            <Container>
                <Row>
                    ...
                    <Col lg={6} className="about-text my-5 mr-lg--5">
                        <blockquote cite="https://quoteinvestigator.com/2016/06/20/books/">
                            ...
                            <footer className="quote-citation"><i>-- Ralph Waldo Emerson</i></footer>
                        </blockquote>
                        <p>
